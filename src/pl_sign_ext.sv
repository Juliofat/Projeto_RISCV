...
module pl_sign_ext (
    ...
    localparam I_TYPE = 7'b0010011; // para as instrucoes com imediato.
    ...
    always_comb begin
        case (Instr[6:0])
            ...
            I_TYPE: ImmExt = {{20{Instr[31]}}, Instr[31:20]}; // logica semelhante com a do LOAD, so muda o opcode msm
